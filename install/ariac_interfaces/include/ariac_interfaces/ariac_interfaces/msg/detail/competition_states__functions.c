...
ariac_interfaces__msg__CompetitionStates__create()
{
  ...
  ariac_interfaces__msg__CompetitionStates * msg = (ariac_interfaces__msg__CompetitionStates *)allocator.allocate(sizeof(ariac_interfaces__msg__CompetitionStates), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ariac_interfaces__msg__CompetitionStates));
  bool success = ariac_interfaces__msg__CompetitionStates__init(msg);
  if (!success) {
...
ariac_interfaces__msg__CompetitionStates__destroy(ariac_interfaces__msg__CompetitionStates * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ariac_interfaces__msg__CompetitionStates__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ariac_interfaces__msg__CompetitionStates__Sequence__init(ariac_interfaces__msg__CompetitionStates__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ariac_interfaces__msg__CompetitionStates * data = NULL;

  if (size) {
    data = (ariac_interfaces__msg__CompetitionStates *)allocator.zero_allocate(size, sizeof(ariac_interfaces__msg__CompetitionStates), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ariac_interfaces__msg__CompetitionStates__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ariac_interfaces__msg__CompetitionStates__fini(&data[i - 1]);
      }
...
ariac_interfaces__msg__CompetitionStates__Sequence__fini(ariac_interfaces__msg__CompetitionStates__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ariac_interfaces__msg__CompetitionStates__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ariac_interfaces__msg__CompetitionStates__Sequence * array = (ariac_interfaces__msg__CompetitionStates__Sequence *)allocator.allocate(sizeof(ariac_interfaces__msg__CompetitionStates__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ariac_interfaces__msg__CompetitionStates__Sequence__init(array, size);
  if (!success) {
...
ariac_interfaces__msg__CompetitionStates__Sequence__destroy(ariac_interfaces__msg__CompetitionStates__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ariac_interfaces__msg__CompetitionStates__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ariac_interfaces__msg__CompetitionStates__Sequence__are_equal(const ariac_interfaces__msg__CompetitionStates__Sequence * lhs, const ariac_interfaces__msg__CompetitionStates__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ariac_interfaces__msg__CompetitionStates__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ariac_interfaces__msg__CompetitionStates__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ariac_interfaces__msg__CompetitionStates);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ariac_interfaces__msg__CompetitionStates * data =
      (ariac_interfaces__msg__CompetitionStates *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ariac_interfaces__msg__CompetitionStates__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ariac_interfaces__msg__CompetitionStates__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ariac_interfaces__msg__CompetitionStates__copy(
