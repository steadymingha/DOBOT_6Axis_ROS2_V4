...
#ifndef ARIAC_INTERFACES__MSG__DETAIL__BREAK_BEAM_STATUS__FUNCTIONS_H_
#define ARIAC_INTERFACES__MSG__DETAIL__BREAK_BEAM_STATUS__FUNCTIONS_H_
 ...
 * calls
 * ariac_interfaces__msg__BreakBeamStatus__init().
...
/**
 * It calls
 * ariac_interfaces__msg__BreakBeamStatus__fini()
 ...
 * ariac_interfaces__msg__BreakBeamStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * ariac_interfaces__msg__BreakBeamStatus__Sequence__fini()
 * on the array,
...
#endif  // ARIAC_INTERFACES__MSG__DETAIL__BREAK_BEAM_STATUS__FUNCTIONS_H_
