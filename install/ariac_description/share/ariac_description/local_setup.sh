...
: ${AMENT_CURRENT_PREFIX:="/home/user/dobot_ws/install/ariac_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ariac_description/environment/ariac_description.sh"
