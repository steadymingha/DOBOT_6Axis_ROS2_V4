...
: ${AMENT_CURRENT_PREFIX:="/home/user/dobot_ws/install/dobot_demo_cpp"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dobot_demo_cpp/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dobot_demo_cpp/environment/path.sh"
