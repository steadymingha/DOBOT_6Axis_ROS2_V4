...
bool dobot_msgs_v4__msg__tool_vector_actual__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v4.msg._tool_vector_actual.ToolVectorActual", full_classname_dest, 54) == 0);
  }
  dobot_msgs_v4__msg__ToolVectorActual * ros_message = _ros_message;
  {  // x
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * dobot_msgs_v4__msg__tool_vector_actual__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of ToolVectorActual */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_msgs_v4.msg._tool_vector_actual");
  ...
  dobot_msgs_v4__msg__ToolVectorActual * ros_message = (dobot_msgs_v4__msg__ToolVectorActual *)raw_ros_message;
  {  // x
    PyObject * field = NULL;
