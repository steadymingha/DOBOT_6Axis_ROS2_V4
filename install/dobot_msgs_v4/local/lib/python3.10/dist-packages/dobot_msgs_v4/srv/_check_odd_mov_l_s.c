...
bool dobot_msgs_v4__srv__check_odd_mov_l__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v4.srv._check_odd_mov_l.CheckOddMovL_Request", full_classname_dest, 55) == 0);
  }
  dobot_msgs_v4__srv__CheckOddMovL_Request * ros_message = _ros_message;
  {  // point1_j1
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * dobot_msgs_v4__srv__check_odd_mov_l__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of CheckOddMovL_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_msgs_v4.srv._check_odd_mov_l");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CheckOddMovL_Request");
  ...
  dobot_msgs_v4__srv__CheckOddMovL_Request * ros_message = (dobot_msgs_v4__srv__CheckOddMovL_Request *)raw_ros_message;
  {  // point1_j1
    PyObject * field = NULL;
...
ROSIDL_GENERATOR_C_EXPORT
bool dobot_msgs_v4__srv__check_odd_mov_l__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v4.srv._check_odd_mov_l.CheckOddMovL_Response", full_classname_dest, 56) == 0);
  }
  dobot_msgs_v4__srv__CheckOddMovL_Response * ros_message = _ros_message;
  {  // robot_return
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * dobot_msgs_v4__srv__check_odd_mov_l__response__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of CheckOddMovL_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_msgs_v4.srv._check_odd_mov_l");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CheckOddMovL_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  dobot_msgs_v4__srv__CheckOddMovL_Response * ros_message = (dobot_msgs_v4__srv__CheckOddMovL_Response *)raw_ros_message;
  {  // robot_return
    PyObject * field = NULL;
