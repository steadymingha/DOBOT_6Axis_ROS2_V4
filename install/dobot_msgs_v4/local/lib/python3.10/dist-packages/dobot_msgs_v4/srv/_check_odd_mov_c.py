...
class Metaclass_CheckOddMovC_Request(type):
    """Metaclass of message 'CheckOddMovC_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__check_odd_mov_c__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__check_odd_mov_c__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__check_odd_mov_c__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__check_odd_mov_c__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__check_odd_mov_c__request
...
class CheckOddMovC_Request(metaclass=Metaclass_CheckOddMovC_Request):
    """Message class 'CheckOddMovC_Request'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.point3_j1 = kwargs.get('point3_j1', float())
        self.point3_j2 = kwargs.get('point3_j2', float())
        self.point3_j3 = kwargs.get('point3_j3', float())
        self.point3_j4 = kwargs.get('point3_j4', float())
        self.point3_j5 = kwargs.get('point3_j5', float())
        self.point3_j6 = kwargs.get('point3_j6', float())
    ...
    def __eq__(self, other):
        ...
        if self.point2_j6 != other.point2_j6:
            return False
        if self.point3_j1 != other.point3_j1:
            return False
        if self.point3_j2 != other.point3_j2:
            return False
        if self.point3_j3 != other.point3_j3:
            return False
        if self.point3_j4 != other.point3_j4:
            return False
        if self.point3_j5 != other.point3_j5:
            return False
        if self.point3_j6 != other.point3_j6:
            return False
    ...
    @builtins.property
    def point3_j1(self):
        """Message field 'point3_j1'."""
        return self._point3_j1

    @point3_j1.setter
    def point3_j1(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'point3_j1' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'point3_j1' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._point3_j1 = value

    @builtins.property
    def point3_j2(self):
        """Message field 'point3_j2'."""
        return self._point3_j2

    @point3_j2.setter
    def point3_j2(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'point3_j2' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'point3_j2' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._point3_j2 = value

    @builtins.property
    def point3_j3(self):
        """Message field 'point3_j3'."""
        return self._point3_j3

    @point3_j3.setter
    def point3_j3(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'point3_j3' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'point3_j3' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._point3_j3 = value

    @builtins.property
    def point3_j4(self):
        """Message field 'point3_j4'."""
        return self._point3_j4

    @point3_j4.setter
    def point3_j4(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'point3_j4' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'point3_j4' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._point3_j4 = value

    @builtins.property
    def point3_j5(self):
        """Message field 'point3_j5'."""
        return self._point3_j5

    @point3_j5.setter
    def point3_j5(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'point3_j5' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'point3_j5' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._point3_j5 = value

    @builtins.property
    def point3_j6(self):
        """Message field 'point3_j6'."""
        return self._point3_j6

    @point3_j6.setter
    def point3_j6(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'point3_j6' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'point3_j6' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._point3_j6 = value
...
class Metaclass_CheckOddMovC_Response(type):
    """Metaclass of message 'CheckOddMovC_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__check_odd_mov_c__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__check_odd_mov_c__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__check_odd_mov_c__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__check_odd_mov_c__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__check_odd_mov_c__response
...
class CheckOddMovC_Response(metaclass=Metaclass_CheckOddMovC_Response):
    """Message class 'CheckOddMovC_Response'."""
...
class Metaclass_CheckOddMovC(type):
    """Metaclass of service 'CheckOddMovC'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dobot_msgs_v4.srv.CheckOddMovC')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__check_odd_mov_c

            from dobot_msgs_v4.srv import _check_odd_mov_c
            if _check_odd_mov_c.Metaclass_CheckOddMovC_Request._TYPE_SUPPORT is None:
                _check_odd_mov_c.Metaclass_CheckOddMovC_Request.__import_type_support__()
            if _check_odd_mov_c.Metaclass_CheckOddMovC_Response._TYPE_SUPPORT is None:
                _check_odd_mov_c.Metaclass_CheckOddMovC_Response.__import_type_support__()


class CheckOddMovC(metaclass=Metaclass_CheckOddMovC):
    from dobot_msgs_v4.srv._check_odd_mov_c import CheckOddMovC_Request as Request
    from dobot_msgs_v4.srv._check_odd_mov_c import CheckOddMovC_Response as Response
