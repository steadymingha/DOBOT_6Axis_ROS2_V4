...
class Metaclass_CheckOddMovJ_Request(type):
    """Metaclass of message 'CheckOddMovJ_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__check_odd_mov_j__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__check_odd_mov_j__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__check_odd_mov_j__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__check_odd_mov_j__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__check_odd_mov_j__request
...
class CheckOddMovJ_Request(metaclass=Metaclass_CheckOddMovJ_Request):
    """Message class 'CheckOddMovJ_Request'."""
...
class Metaclass_CheckOddMovJ_Response(type):
    """Metaclass of message 'CheckOddMovJ_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__check_odd_mov_j__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__check_odd_mov_j__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__check_odd_mov_j__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__check_odd_mov_j__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__check_odd_mov_j__response
...
class CheckOddMovJ_Response(metaclass=Metaclass_CheckOddMovJ_Response):
    """Message class 'CheckOddMovJ_Response'."""
...
class Metaclass_CheckOddMovJ(type):
    """Metaclass of service 'CheckOddMovJ'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dobot_msgs_v4.srv.CheckOddMovJ')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__check_odd_mov_j

            from dobot_msgs_v4.srv import _check_odd_mov_j
            if _check_odd_mov_j.Metaclass_CheckOddMovJ_Request._TYPE_SUPPORT is None:
                _check_odd_mov_j.Metaclass_CheckOddMovJ_Request.__import_type_support__()
            if _check_odd_mov_j.Metaclass_CheckOddMovJ_Response._TYPE_SUPPORT is None:
                _check_odd_mov_j.Metaclass_CheckOddMovJ_Response.__import_type_support__()


class CheckOddMovJ(metaclass=Metaclass_CheckOddMovJ):
    from dobot_msgs_v4.srv._check_odd_mov_j import CheckOddMovJ_Request as Request
    from dobot_msgs_v4.srv._check_odd_mov_j import CheckOddMovJ_Response as Response
