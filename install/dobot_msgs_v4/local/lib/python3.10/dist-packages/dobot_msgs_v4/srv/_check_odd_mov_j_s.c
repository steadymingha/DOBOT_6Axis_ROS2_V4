...
bool dobot_msgs_v4__srv__check_odd_mov_j__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v4.srv._check_odd_mov_j.CheckOddMovJ_Request", full_classname_dest, 55) == 0);
  }
  dobot_msgs_v4__srv__CheckOddMovJ_Request * ros_message = _ros_message;
  {  // point1_j1
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * dobot_msgs_v4__srv__check_odd_mov_j__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of CheckOddMovJ_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_msgs_v4.srv._check_odd_mov_j");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CheckOddMovJ_Request");
  ...
  dobot_msgs_v4__srv__CheckOddMovJ_Request * ros_message = (dobot_msgs_v4__srv__CheckOddMovJ_Request *)raw_ros_message;
  {  // point1_j1
    PyObject * field = NULL;
...
ROSIDL_GENERATOR_C_EXPORT
bool dobot_msgs_v4__srv__check_odd_mov_j__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v4.srv._check_odd_mov_j.CheckOddMovJ_Response", full_classname_dest, 56) == 0);
  }
  dobot_msgs_v4__srv__CheckOddMovJ_Response * ros_message = _ros_message;
  {  // robot_return
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * dobot_msgs_v4__srv__check_odd_mov_j__response__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of CheckOddMovJ_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_msgs_v4.srv._check_odd_mov_j");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CheckOddMovJ_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  dobot_msgs_v4__srv__CheckOddMovJ_Response * ros_message = (dobot_msgs_v4__srv__CheckOddMovJ_Response *)raw_ros_message;
  {  // robot_return
    PyObject * field = NULL;
